...
public final class MatchResult {
    ...
    public static MatchResult accepted(){
        return new MatchResult(MatchingOutcome.ACCEPTED, null, new LinkedList<>());
    }
    public static MatchResult activated(){
        return new MatchResult(MatchingOutcome.ACTIVATED, null, new LinkedList<>());
    }
